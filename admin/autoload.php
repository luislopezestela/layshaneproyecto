        ...
        <div class="navigation">
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    <?php if ($is_admin || ($is_moderoter && ($wo['user']['permission']['manage-stickers'] == 1 || $wo['user']['permission']['add-new-sticker'] == 1 || $wo['user']['permission']['manage-gifts'] == 1 || $wo['user']['permission']['add-new-gift'] == 1 || $wo['user']['permission']['administrar-publicaciones'] == 1 || $wo['user']['permission']['manage-articles'] == 1 || $wo['user']['permission']['products-sub-categories'] == 1 || $wo['user']['permission']['blogs-categories'] == 1 || $wo['user']['permission']['products-categories'] == 1 || $wo['user']['permission']['administrar-ofertas'] == 1 || $wo['user']['permission']['administrar-sucursales'] == 1 || $wo['user']['permission']['proveedores'] == 1 || $wo['user']['permission']['unidad-medidad'] == 1 || $wo['user']['permission']['compras'] == 1 || $wo['user']['permission']['manage-products'] == 1 || $wo['user']['permission']['manage-orders'] == 1))) { ?>

                     <li <?php echo ($page == 'manage-stickers' || $page == 'add-new-sticker' || $page == 'manage-gifts' || $page == 'add-new-gift' || $page == 'administrar-publicaciones' || $page == 'manage-articles' || $page == 'products-sub-categories' || $page == 'blogs-categories' || $page == 'products-categories' || $page == 'administrar-ofertas' || $page == 'administrar-sucursales' || $page == 'proveedores'  || $page == 'unidad-medidad' || $page == 'compras' || $page == 'manage-products' || $page == 'manage-orders') ? 'class="open"' : ''; ?>>
                        <a href="#">
                            <span class="nav-link-icon">
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php if ($is_admin || ($is_moderoter && ($wo['user']['permission']['products-sub-categories'] == 1 || $wo['user']['permission']['blogs-categories'] == 1 || $wo['user']['permission']['products-categories'] == 1 ))) { ?>
                            <li <?php echo ($page == 'products-sub-categories' || $page == 'blogs-categories' || $page == 'products-categories') ? 'class="open"' : ''; ?>>
