...
<div class="container-fluid">
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="#">Administrar caracteristicas</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="#">Category</a>
                </li>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                  <h6 class="card-title">Agregar sub categoria de productos</h6>
                  <div class="row">
                                  ...
                                  <div class="form-group form-float">
                                    <div class="form-line">
                                      ...
                                      <select class="form-control show-tick" id="category_id" name="category_id">
                                        <?php foreach ($wo['products_categories'] as $category_id => $category_name) { ?>
