			...
			<div class="page-margin wow_content wow_sett_content">
				<form class="create-album-form form-horizontal" method="post">
					...
					<div class="wow_form_fields">
						...
						<textarea name="description" rows="4" id="description" placeholder="<?php echo $wo['lang']['please_describe_your_product'] ?>"><?php echo htmlspecialchars_decode($wo['product']['edit_description'])?></textarea>
					</div>
					<div class="row">
						<div class="col-md-8">
							<div class="wow_form_fields">
					...
					<div class="text-center">
						...
						<a class="btn btn-mat" href="<?php echo lui_SeoLink('index.php?link1=my-products'); ?>">
