			...
			if (count($info) > 0) {
				foreach ($info as $key => $wo['result']) {
					if ($wo['result']['sort_type'] == 'user') {
						echo lui_LoadPage('search/linkedin_user_list');
					}
					if ($wo['result']['sort_type'] == 'page') {
						echo lui_LoadPage('search/linkedin_page_list');
					}
					if ($wo['result']['sort_type'] == 'group') {
						echo lui_LoadPage('search/linkedin_group_list');
					}
					if ($wo['result']['sort_type'] == 'service') {
						echo lui_LoadPage('search/linkedin_service_list');
					}
				}
			} else {
