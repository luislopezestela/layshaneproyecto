<div class="wo_settings_page wow_content">
	<div class="avatar-holder profile">
		...
		<div class="infoz">
			...
			<p><?php echo $wo['lang']['projects']; ?></p>
		</div>
	</div>
	<hr>
	
	<div class="text-center">
		<a href="javascript:void();" class="btn btn-main btn-mat btn-mat-raised" onclick="NewProjects();"><?php echo $wo['lang']['add_new'];?> <?php echo $wo['lang']['projects']; ?></a>
	</div>
  ...
  <div class="modal-dialog modal-md wow_mat_mdl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title"> <?php echo $wo['lang']['delete_your_project']; ?></h5>
      </div>
      <div class="modal-body">
        <?php echo $wo['lang']['are_you_delete_your_project']; ?>
      </div>  
...
<div class="modal fade" id="add_project_modal" role="dialog" data-keyboard="false" style="overflow-y: auto;">
  <div class="modal-dialog wow_mat_mdl">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></button>
        <h4 class="modal-title"><?php echo $wo['lang']['add_new_project'] ?></h4>
      </div>
        ...
        <div class="modal-body twocheckout_modal">
          ...
          <div class="col-lg-12">
          	<div class="wow_form_fields">
          		<label><?php echo $wo['lang']['project_name']; ?></label> 
          ...
          <div class="col-lg-6">
          	<div class="wow_form_fields">
          		<label><?php echo $wo['lang']['associated_with']; ?></label> 
	            <input name="associated_with" type="text" autocomplete="off">
	          </div>
          </div>
          <div class="col-lg-6">
          	<div class="wow_form_fields">
	          	<label><?php echo $wo['lang']['project_url']; ?></label> 
