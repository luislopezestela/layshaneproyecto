      ...
      <div class="login_left_combo_parent">
         <div class="login_left_combo">
            <form id="login" method="post">
               <p class="title main"><?=str_replace(array('{site_name}', '{Site_Name}', '{sito_name}'), array($wo['config']['siteName'], $wo['config']['siteName'], $wo['config']['siteName']), $wo['lang']['login'])?></p>
