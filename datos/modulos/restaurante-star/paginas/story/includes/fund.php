	...
	<div class="post" id="post-<?php echo $wo['story']['id']; ?>" data-post-id="<?php echo $wo['story']['id'];?>">
		<div class="panel panel-white panel-shadow wo_view_post_jobs">
            ...
            <div class="wo_view_post_jcover">
               <img src="<?php echo lui_GetMedia($wo['story']['fund']['fund']['image']); ?>" alt="Picture">
            </div>
            <?php endif; ?>
			<div class="wo_view_post_jhead">
				<?php if ($wo['story']['fund']['user_id'] == $wo['user']['id']) { ?>
					<div class="dropdown">
				...
				<div class="jinfo">
					...
					<?php } ?>
					<h4><a href="<?php echo $wo['story']['job']['page']['url']; ?>" data-ajax="?link1=timeline&u=<?php echo $wo['story']['job']['page']['page_name']; ?>"><?php echo $wo['story']['job']['page']['page_name']?></a></h4>
						...
						<?php if ($wo['loggedin'] == true) { ?>
							<?php if ($wo['story']['job']['user_id'] == $wo['user']['id']) { ?>
								<?php if ($wo['story']['job']['apply_count'] > 0) { ?>
									<a type="button" class="btn btn-main form-control" href="<?php echo $wo['story']['job']['page']['url'];?>/job_apply?id=<?php echo $wo['story']['job']['id']; ?>"><?php echo $wo['lang']['show_apply'] ?> (<?php echo $wo['story']['job']['apply_count']; ?>)</a>
								<?php }else{ ?>
									<button type="button" class="btn btn-main form-control" disabled><?php echo $wo['lang']['show_apply'] ?> (<?php echo $wo['story']['job']['apply_count']; ?>)</button>
								<?php } ?>
							<?php }else{ ?>
			...
			<div class="wo_vew_apld_blocks">
				...
				<div class="post-description" id="post-description-<?php echo $wo['story']['job']['id']; ?>">
					<?php if (!empty($wo['story']['job']['description'])) { ?>
						<p class="edited_text"><?php echo $wo['story']['job']['description']; ?></p>
					<?php } ?>
				</div>
			</div>
		</div>
