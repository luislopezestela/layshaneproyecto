<div class="wrapper">
	<div class="login forgot_pass">
		...
		<form id="reset-form" method="post">
			<p class="title main"><?php echo $wo['lang']['reset_new_password_label']?></p>
			...
			<div class="login_signup_combo">
				<div class="login__">
					<button type="submit" class="btn btn-main btn-mat add_wow_loader"><?php echo $wo['lang']['reset_password']?></button>
				</div>
