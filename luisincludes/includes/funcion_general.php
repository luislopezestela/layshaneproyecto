...
function lui_SeoLink($query = '') {
    ...
    if ($wo['config']['seoLink'] == 1) {
        $query = preg_replace(array(
            ...
            '/^index\.php\?link1=timeline&items=([A-Za-z0-9_-]+)&type=([A-Za-z0-9_-]+)&id=([A-Za-z0-9_-]+)$/i',
            ...
            '/^index\.php\?link1=([^\/]+)&items=([A-Za-z0-9_-]+)$/i',
            '/^index\.php\?link1=timeline&u=([A-Za-z0-9_]+)&type=([A-Za-z0-9_-]+)$/i',
            '/^index\.php\?link1=timeline&items=([A-Za-z0-9_-]+)&type=([A-Za-z0-9_-]+)$/i',
