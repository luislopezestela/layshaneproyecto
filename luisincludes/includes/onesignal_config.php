<?php
function lui_SendPushNotification($data = array(), $push_type = 'chat') {
    ...
    $data['notification']['notification_content'] = lui_EmoPhone($data['notification']['notification_content']);
    $data['notification']['notification_content'] = lui_EditMarkup($data['notification']['notification_content']);
