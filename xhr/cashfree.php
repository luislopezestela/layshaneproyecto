...
if ($f == 'cashfree') {
	            ...
	            if ($mysqli) {
	                ...
	                if ((!empty($_SESSION['ref']) || !empty($wo['user']['ref_user_id'])) && $wo['config']['affiliate_type'] == 0 && $wo['user']['referrer'] == 0) {
	                    ...
	                    elseif (!empty($wo['user']['ref_user_id'])) {
	                        $ref_user_id = lui_UserIdFromUsername($wo['user']['ref_user_id']);
	                    }
	                ...
	                header("Location: " . lui_SeoLink('index.php?link1=upgraded'));
	                exit();
	            }
	        } else {
	            header("Location: " . lui_SeoLink('index.php?link1=oops'));
    ...
    if ($s == 'wallet') {
    	...
    	$wo['user'] = lui_UserData(lui_Secure($_GET["user_id"]));
		if (!empty($wo['user'])) {
