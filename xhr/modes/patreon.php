...
if ($f == 'tier') {
    ...
    if ($s == 'edit') {
        ...
        if (empty($data['message'])) {
            ...
            $tier = $db->where('id',lui_Secure($_POST['id']))->getOne(T_USER_TIERS);
            if (!empty($tier) && ($tier->user_id == $wo['user']['user_id'] || lui_IsAdmin())) {
                ...
                $update_array = array('title' => lui_Secure($_POST['title']),
                                      'price' => lui_Secure($_POST['price']),
                                      'chat' => $chat,
                                      'live_stream' => $live_stream,
                                      'description' => $description);
