<?php 
if ($f == "new-film") {
    if (lui_IsAdmin() == true || lui_IsModerator() == true) {
        ...
        if (empty($error)) {
            $registration_data = array(
                ...
                'genre' => lui_Secure($_POST['genre']),
                'stars' => lui_Secure($_POST['stars']),
                'producer' => lui_Secure($_POST['producer']),
                'country' => lui_Secure($_POST['country']),
                'release' => lui_Secure($_POST['release']),
                'quality' => lui_Secure($_POST['quanlity']),
                'duration' => lui_Secure($_POST['duration']),
                'description' => lui_Secure($_POST['description']),
                'iframe' => (!empty($_POST['iframe']) && lui_IsUrl($_POST['iframe'])) ? $_POST['iframe'] : '',
                'video' => (!empty($_POST['other']) && lui_IsUrl($_POST['other'])) ? $_POST['other'] : '',
                'rating' => lui_Secure($_POST['rating'])
            );
            $film_id           = lui_InsertFilm($registration_data);
