...
if ($f == 'update_user_avatar_picture') {
    ...
    if (isset($_FILES['avatar']['name'])) {
        $upload = lui_UploadImage($_FILES["avatar"]["tmp_name"], $_FILES['avatar']['name'], 'avatar', $_FILES['avatar']['type'], $_POST['user_id']);
        if ($upload === true) {
            ...
            $data = array(
                ...
                'avatar_full' => lui_GetMedia($img['avatar_full']) . '?cache=' . rand(11, 22),
